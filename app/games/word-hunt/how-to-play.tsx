...
import { SpeechBalloon } from '../../../src/games/word-hunt/components/SpeechBalloon';
import { mergeLetterStates, scoreGuess } from '../../../src/games/word-hunt/core/gameEngine';
import {
  FLIP_REVEAL_MS,
  TUTORIAL_SECRET,
  TUTORIAL_STEPS,
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {isComplete ? (
        <Pressable
          ...
          onPress={() =>
            router.replace({ pathname: '/games/word-hunt/play', params: { mode: 'practice' } })
          }
        >
...
const styles = StyleSheet.create({
  ...
  balloonArea: { paddingHorizontal: 4, paddingBottom: 4, alignItems: 'center' },
  boardArea: { flex: 1, alignItems: 'center', justifyContent: 'center', minHeight: 0 },
  boardAreaCompact: { flexGrow: 0, flexShrink: 1, justifyContent: 'flex-start', paddingTop: 4 },
  keyboardArea: { flexShrink: 0, paddingTop: 8 },
  playButton: {
    marginHorizontal: 12,
    marginTop: 12,
    borderRadius: 10,
