  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.topBar}>
        ...
        <Text style={[styles.gameTitle, { color: theme.textPrimary }]}>Word Hunt</Text>
        <HeaderIconButton
          name="settings-outline"
          onPress={() => router.push('/games/word-hunt/settings')}
          accessibilityLabel="Word Hunt settings"
        />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.actions}>
          <Pressable
            ...
            onPress={() => router.push({ pathname: '/games/word-hunt/play', params: { mode: 'daily' } })}
            disabled={dailyDone}
          >
          ...
          <Pressable
            ...
            onPress={() => router.push({ pathname: '/games/word-hunt/play', params: { mode: 'practice' } })}
          >
          ...
          <Pressable
            ...
            onPress={() => router.push('/games/word-hunt/create-puzzle')}
          >
          ...
          <Pressable
            ...
            onPress={() => router.push('/games/word-hunt/stats')}
          >
          ...
          <Pressable
            style={({ pressed }) => [styles.linkButton, pressed && styles.pressed]}
            onPress={() => router.push('/games/word-hunt/how-to-play')}
          >
