...
const DIFFICULTIES: FlowDifficulty[] = ['easy', 'medium', 'hard'];

const DIFFICULTY_LABELS: Record<FlowDifficulty, string> = {
  easy: 'Easy (4×4)',
  medium: 'Medium (6×6)',
  hard: 'Hard (8×8)',
};

interface ColorFlowDifficultyPickerProps {
  difficulty: FlowDifficulty;
  onChange: (difficulty: FlowDifficulty) => void;
  hint?: string;
}
