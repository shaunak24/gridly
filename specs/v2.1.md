...
Future work promoted from the pre-v2.0 backlog. Not in active development.
...
| Grid Snap polish | Image caching, move stats, share completed puzzle, 8×8 performance tuning |
