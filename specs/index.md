...
**Current release:** v3.0.2 (Google OAuth deep link fix). See [changelog.md](./changelog.md) for version history and planned work.
...
| Area | Start here |
|------|------------|
| What the app does today | [experience.md](./experience.md), [v3.0.md](./v3.0.md), [v3.0.2.md](./v3.0.2.md) |
