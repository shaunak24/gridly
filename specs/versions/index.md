...
Shipped release scopes for Gridly. Each file is the authoritative acceptance criteria for that semver. **Current release:** [v4.3.2](./v4.3.2.md). History summary: [changelog.md](../changelog.md).
...
| [v3.2.1](./v3.2.1.md) | Stats sync fix (per-account storage) |
...
Frozen MVP baseline: [mvp.md](../mvp.md).
